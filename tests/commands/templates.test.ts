...
describe('templatesApi.articleTemplates', () => {
  it('returns article templates', async () => {
    nock(BASE_URL)
      .get('/api/external/v2/templates/article')
      .reply(200, { templates: [{ id: 1, name: 'Blog Post', requires_video: true }] });
...
describe('templatesApi.structureTemplates', () => {
  it('returns structure templates', async () => {
    nock(BASE_URL)
      .get('/api/external/v2/templates/structure')
      .reply(200, { templates: [{ id: 2, name: 'Course', requires_video: false }] });
